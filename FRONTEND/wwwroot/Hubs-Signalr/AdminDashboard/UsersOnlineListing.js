...
//    connection.invoke("CountUsers").catch(function (error) {
//        console.log(error);
//    });
//});
...
var connection = new signalR.HubConnectionBuilder().withUrl("/usersOnlineListingHub").build();
// End:

// Shafi: When connection is on executive this
connection.on("UsersOnline", function (count) {

    $("#listings").html(count + " Users");
